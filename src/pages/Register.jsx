...
<PageTitleImage
  ...
  subtitle="JOIN US AND ENJOY A PERSONALIZED SHOPPING EXPERIENCE"
        ...
        <div className="s-log">
            ...
            <form className="form-login">
              ...
              <div className="orther-log list-ver">
                <div className="text-social">
                  ...
                  <p className="h6 text-nowrap">Or continue with social account</p>
                  <span className="br-line"></span>
                </div>
          ...
          <div className="col-right">
            ...
            <p className="h6 text-sub">
              Welcome back, log in to your account to enhance your shopping experience,
              receive coupons, and the best discount codes.
            </p>
            <Link to="/login" className="btn_log tf-btn animate-btn">
              Login
            </Link>
          </div>
        </div>
